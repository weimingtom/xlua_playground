    ...
    public partial class StaticLuaCallbacks
    {
        ...
        public static int LuaGC(RealStatePtr L)
        {
            try
            {
                ...
                {
                    ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
                    if (translator != null) //FIXME:breakpoint //FIXME:原来的代码没有判断空
                    {
            ...
            {
            	System.Diagnostics.Debug.WriteLine("c# exception in LuaGC:" + e);
...
//FIXME:breakpoint
        ...
        internal static int LoadFromResource(RealStatePtr L)
        {
            try
            {
                ...
                UnityEngine.TextAsset file = new UnityEngine.TextAsset(filename);
                if (file == null)
                {
                    LuaAPI.lua_pushstring(L, string.Format(
        ...
        public static int ImportType(RealStatePtr L)
        {
            try
            {
                ...
                Type type = translator.FindType(className); //FIXME:breakpoint //FIXME:定位CS.XXX.XXX类
                if (type != null)
                {
