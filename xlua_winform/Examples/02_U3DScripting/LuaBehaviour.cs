/*
InvalidCastException: This type must add to CSharpCallLua: System.Action
...
public class LuaBehaviour : MonoBehaviour {
    ...
    private Light lightObject = new Light();
    public LuaBehaviour()
    {
    	luaScript = new TextAsset("Examples/02_U3DScripting/LuaTestScript.lua.txt");
    	injections = new Injection[] {
    		new Injection() {name = "lightObject", value = lightObject}
    	};
    }
