...
Gen/XLuaGenAutoRegister.cs->Gen/XLuaTestMyStructWrap.cs->Gen/WrapPusher.cs->Gen/PackUnpack.cs->CopyByValue.cs
...
----------------------------------------------------
(1)
InvalidCastException: This type must add to CSharpCallLua: XLuaTest.IntParam
...
XLuaTest.NoGc.Update () (at Assets/Examples/05_NoGc/NoGc.cs:190)


Start() :System.InvalidCastException: This type must add to CSharpCallLua: XLuaTest.IntParam
   在 XLua.LuaTable.Get[TKey,TValue](TKey key, TValue& value) 位置 e:\sync\xlua\xlua\XLua\Src\LuaTable.cs:行号 65
   在 XLuaTest.NoGc.Start() 位置 e:\sync\xlua\xlua\Examples\05_NoGc\NoGc.cs:行号 175
   在 xlua.MainForm.MainFormLoad(Object sender, EventArgs e) 位置 e:\sync\xlua\xlua\MainForm.cs:行号 50
update() : System.NullReferenceException: 未将对象引用设置到对象的实例。
   在 XLuaTest.NoGc.Update() 位置 e:\sync\xlua\xlua\Examples\05_NoGc\NoGc.cs:行号 200
   在 xlua.MainForm.timer1EventProcessor(Object source, EventArgs e) 位置 e:\sync\xlua\xlua\MainForm.cs:行号 65
